            ...
            <div class="login-form">
                ...
                <div class="login-form-items">
                    ...
                    <div class="form-signin">
                        <button class="btn" v-on:click="signup">Register Now</button>
                    </div>
                    <div class="or-option">
                        <p>or</p>
                    </div>
                    <div class="form-signup">
                        <router-link class="btn" to="/login">Login Now</router-link>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        async signup() {
            ...
            if (result.status == 201) {
                localStorage.setItem('signUp', JSON.stringify(result.data));
                this.$router.push({
                    name: 'Home'
                });
            }
